...
export const translations = {
  pt: {
      ...
      slides: [
        {
          ...
          pill: '66,7% de aprovação · 10h45 economizadas',
          cards: {
            a: { title: 'Pedido aprovado', sub: 'Análise automática · 12 min' },
            b: { label: 'Processado no mês', value: 'R$ 396.145,03' },
            c: {
              label: 'Score de crédito',
              badge: 'Baixo risco',
              bottomLabel: 'Limite sugerido',
              bottomValue: 'R$ 150.000',
              action: 'Aprovar',
            },
            d: { label: 'Tempo médio de análise', delta: '-82%', sub: 'De 51 dias para minutos' },
          },
        },
        {
          src: '/painel-cobranca.webp',
          url: 'app.letmesee.com.br/cobranca',
          alt: 'Painel de cobrança do LETMESEE: filas, indicadores e acordos',
          pill: '57% menos inadimplência · cobrança no automático',
          cards: {
            a: { title: 'Acordo fechado', sub: 'Régua automática · D+5' },
            b: { label: 'Recuperado no mês', value: 'R$ 47.320,00' },
            c: {
              label: 'Carteira em cobrança',
              badge: '338 clientes',
              bars: [
                { label: '30d', pct: 88 },
                { label: '60d', pct: 56 },
              ...
              bottomLabel: 'Total em aberto',
              bottomValue: 'R$ 58,2M',
              action: 'Negociar',
            },
            d: { label: 'Acordos fechados', delta: '+24%', sub: 'Sem uma ligação do seu time' },
          },
        },
      ],
    },
    ...
    footer: {
      ...
      conteudosTitle: 'Conteúdos',
      conteudos: {
        ebook: 'E-book Política de Crédito',
        prompt: 'Prompt de IA',
        blog: 'Blog',
      },
...
Responda de forma curta e direta, só com os fatos pedidos. Não adicione explicações desnecessárias.`,
    ...
    blog: {
      eyebrow: 'Blog',
      title: 'Conteúdo para quem decide crédito e cobrança',
      subtitle:
        'Método, dados e prática para vender mais a prazo com segurança e recuperar antes que vire perda. Sem jargão, sem promessa que o número não sustenta.',
      metaTitle: 'Blog Lenext — crédito e cobrança B2B na prática',
      metaDescription:
        'Artigos sobre política de crédito, régua de cobrança, automação de decisão e o mercado brasileiro de crédito e cobrança. Escritos para CFOs e gestores de crédito.',
      backToSite: 'Voltar ao site',
      ...
      empty: 'Ainda não há artigos publicados nesta categoria.',
      notFoundTitle: 'Não encontramos este artigo',
      notFoundDesc: 'O link pode ter mudado. Veja os artigos publicados no blog.',
      cta: {
        ebook: {
          title: 'Política de Crédito na Prática',
          desc: 'O guia completo em PDF: os 7 pilares, a matriz de alçadas, o checklist de 20 itens e o template do documento de política.',
          label: 'Baixar o e-book gratuito',
        },
        demo: {
          title: 'Veja aplicado à sua operação',
          desc: 'Em uma conversa, mostramos como a política e a régua de cobrança rodam automaticamente sobre a sua carteira.',
          label: 'Falar com um especialista',
        },
      },
      newsletter: {
        title: 'Receba os próximos artigos',
        desc: 'Um e-mail por semana sobre crédito, cobrança e decisão. Escrito para quem opera, não para quem vende.',
        name: 'Nome',
        namePlaceholder: 'Seu nome',
        email: 'E-mail corporativo',
        emailPlaceholder: 'voce@empresa.com.br',
        consent: 'Autorizo a Lenext a me enviar conteúdos por e-mail.',
        button: 'Quero receber',
        sending: 'Enviando…',
        disabledHint: 'Preencha nome, e-mail e marque a autorização.',
        success: 'Pronto! Você vai receber o próximo artigo.',
        privacy: 'Seus dados são tratados conforme a LGPD. Cancele quando quiser.',
      },
    },
  ...
  en: {
      ...
      slides: [
        {
          src: '/painel-credito.webp',
          url: 'app.letmesee.com.br/analise-de-credito',
          alt: 'LETMESEE credit analysis dashboard: approval, SLA, risk, and orders',
          pill: '66.7% approval rate · 10h45 saved',
          cards: {
            a: { title: 'Order approved', sub: 'Automatic analysis · 12 min' },
            b: { label: 'Processed this month', value: 'R$ 396,145.03' },
            c: {
              label: 'Credit score',
              badge: 'Low risk',
              bottomLabel: 'Suggested limit',
              bottomValue: 'R$ 150,000',
              action: 'Approve',
            },
            d: { label: 'Average analysis time', delta: '-82%', sub: 'From 51 days to minutes' },
          },
        },
        {
          src: '/painel-cobranca.webp',
          url: 'app.letmesee.com.br/cobranca',
          alt: 'LETMESEE collections dashboard: queues, KPIs, and settlements',
          pill: '57% less default · collections on autopilot',
          cards: {
            a: { title: 'Deal closed', sub: 'Automatic rule · D+5' },
            b: { label: 'Recovered this month', value: 'R$ 47,320.00' },
            c: {
              label: 'Collections portfolio',
              badge: '338 clients',
              bars: [
                { label: '30d', pct: 88 },
                { label: '60d', pct: 56 },
              ...
              bottomLabel: 'Total outstanding',
              bottomValue: 'R$ 58.2M',
              action: 'Negotiate',
            },
            d: { label: 'Deals closed', delta: '+24%', sub: 'Without a single call from your team' },
          },
        },
      ],
    },
    ...
    footer: {
      ...
      conteudosTitle: 'Content',
      conteudos: {
        ebook: 'Credit Policy e-book',
        prompt: 'AI prompt',
        blog: 'Blog',
      },
...
Responda de forma curta e direta, só com os fatos pedidos. Não adicione explicações desnecessárias.`,
    ...
    blog: {
      eyebrow: 'Blog',
      title: 'Content for teams that decide credit and collections',
      subtitle:
        'Method, data and practice to sell more on terms safely and recover before it becomes a loss. No jargon, no promise the numbers do not support.',
      metaTitle: 'Lenext Blog — B2B credit and collections in practice',
      metaDescription:
        'Articles on credit policy, dunning journeys, decision automation and the Brazilian credit and collections market. Written for CFOs and credit managers.',
      backToSite: 'Back to site',
      ...
      notFoundTitle: 'We could not find this article',
      notFoundDesc: 'The link may have changed. Browse the published articles instead.',
      cta: {
        ebook: {
          title: 'Credit Policy in Practice',
          desc: 'The full PDF guide: the 7 pillars, the approval matrix, a 20-item checklist and the policy document template.',
          label: 'Download the free e-book',
        },
        demo: {
          title: 'See it applied to your operation',
          desc: 'In one conversation we show how the policy and the dunning journey run automatically over your portfolio.',
          label: 'Talk to a specialist',
        },
      },
      newsletter: {
        title: 'Get the next articles',
        desc: 'One email a week on credit, collections and decisioning. Written for people who run it, not for people who sell it.',
        name: 'Name',
        namePlaceholder: 'Your name',
        email: 'Work email',
        emailPlaceholder: 'you@company.com',
        consent: 'I agree to receive content from Lenext by email.',
        button: 'Sign me up',
        sending: 'Sending…',
        disabledHint: 'Fill in your name, email and tick the consent box.',
        success: 'Done! You will get the next article.',
        privacy: 'Your data is handled under LGPD. Unsubscribe anytime.',
      },
    },
